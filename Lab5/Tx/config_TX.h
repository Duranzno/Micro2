...
void  CONFIG_CM(){
  ...
  CM3CONbits.COE=0;  CM1CONbits.COE=0;
  CM3CONbits.CON=1;  CM1CONbits.CON=1;
  CM3CONbits.CPOL=0; CM1CONbits.CPOL=0;
  ...
  CVRCONbits.BGSEL=1;  CVRCONbits.CVREN=1;
  CM1CONbits.CEN=1;  CM3CONbits.CEN=1; 
 }

void config_vref () {
    CM1CONbits.CON=1;    CVRCONbits.CVREN=1;
    CVRCONbits.CVROE=1;    CVRCONbits.BGSEL=1;
    CVRCONbits.CVRR=0;
    ANSELBbits.ANSB10=1;    TRISBBITS.TRISB10=0;
    CVRCONbits.CVR=15;    CVRCONbits.VREFSEL=0;
}
void config_USB(){
  ...
  //SE REQUIEREN 48MHZ
  ACLKCON3 = 0x24C0;  ACLKDIV3 = 0x7;  ACLKCON3bits.ENAPLL = 1;
