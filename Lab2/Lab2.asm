...
;Lab2.c,144 :: 		Glcd_Write_Text("PLAY",30,7,1);
	...
	CALL	_Glcd_Write_Text
;Lab2.c,145 :: 		T1CONBits.TON=1;
	BSET	T1CONbits, #15
;Lab2.c,146 :: 		break;
	GOTO	L_caso_1108
;Lab2.c,147 :: 		case 3:
L_caso_1111:
;Lab2.c,148 :: 		Glcd_Write_Text("pause",30,7,1);
	MOV.B	#1, W13
	MOV.B	#7, W12
	MOV.B	#30, W11
	MOV	#lo_addr(?lstr38_Lab2), W10
	CALL	_Glcd_Write_Text
;Lab2.c,149 :: 		T1CONBits.TON=0;
	BCLR	T1CONbits, #15
;Lab2.c,150 :: 		break;
	GOTO	L_caso_1108
;Lab2.c,151 :: 		case 4:
L_caso_1112:
;Lab2.c,152 :: 		Glcd_Write_Text("RESET",30,7,1);
	MOV.B	#1, W13
	MOV.B	#7, W12
	MOV.B	#30, W11
...
;Lab2.c,155 :: 		case 5:
L_caso_1113:
;Lab2.c,156 :: 		Glcd_Write_Text("ALARM",30,7,1);
	MOV.B	#1, W13
	MOV.B	#7, W12
	MOV.B	#30, W11
...
;Lab2.c,162 :: 		void caso_2(){
;Lab2.c,163 :: 		while(keydata!=ESC){
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
L_caso_2114:
	...
	GOTO	L_caso_2115
L__caso_2250:
;Lab2.c,164 :: 		if(!FloatToStr(T1,txt)){Glcd_Write_Text(txt,65,1,1);}
...
L__caso_2251:
	...
	CALL	_Glcd_Write_Text
L_caso_2116:
;Lab2.c,165 :: 		if(!FloatToStr(T2,txt)){Glcd_Write_Text(txt,65,2,1);}
	MOV	#lo_addr(_txt), W12
	MOV	_T2, W10
	MOV	_T2+2, W11
	CALL	_FloatToStr
...
L__caso_2252:
	...
	CALL	_Glcd_Write_Text
L_caso_2117:
;Lab2.c,166 :: 		if(!FloatToStr(T3,txt)){Glcd_Write_Text(txt,65,3,1);}
	MOV	#lo_addr(_txt), W12
	MOV	_T3, W10
	MOV	_T3+2, W11
	CALL	_FloatToStr
...
L__caso_2253:
	...
	CALL	_Glcd_Write_Text
L_caso_2118:
;Lab2.c,167 :: 		if(!FloatToStr(T4,txt)){Glcd_Write_Text(txt,65,4,1);}
	MOV	#lo_addr(_txt), W12
	MOV	_T4, W10
	MOV	_T4+2, W11
	CALL	_FloatToStr
...
L__caso_2254:
	...
	CALL	_Glcd_Write_Text
L_caso_2119:
;Lab2.c,168 :: 		Ps2_Key_Read(&keydata, &special, &down);
	MOV	#lo_addr(_down), W12
	MOV	#lo_addr(_special), W11
	MOV	#lo_addr(_keydata), W10
	CALL	_Ps2_Key_Read
...
;Lab2.c,172 :: 		void main(){
;Lab2.c,173 :: 		config_IO();  config_LCD();
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
	CALL	_config_IO
	CALL	_config_LCD
;Lab2.c,174 :: 		config_INT(); config_TMR();
	CALL	_config_INT
	CALL	_config_TMR
;Lab2.c,176 :: 		animate_charmander_5s(); Glcd_Fill(0);
	CALL	_animate_charmander_5s
	CLR	W10
	CALL	_Glcd_Fill
;Lab2.c,178 :: 		PS2_Config();  Glcd_Fill(0);
	CALL	_Ps2_Config
	CLR	W10
	CALL	_Glcd_Fill
;Lab2.c,179 :: 		while(1){
L_main120:
;Lab2.c,180 :: 		texto_menu();
	CALL	_texto_menu
;Lab2.c,181 :: 		if(Ps2_Key_Read(&keydata, &special, &down)){
	MOV	#lo_addr(_down), W12
	MOV	#lo_addr(_special), W11
	MOV	#lo_addr(_keydata), W10
	CALL	_Ps2_Key_Read
...
;Lab2.c,182 :: 		if(down){
	...
	GOTO	L_main123
L__main257:
;Lab2.c,183 :: 		Glcd_Write_TEXT("Entrar",0,7,1);
	MOV.B	#1, W13
	MOV.B	#7, W12
	CLR	W11
	MOV	#lo_addr(?lstr41_Lab2), W10
	CALL	_Glcd_Write_Text
;Lab2.c,184 :: 		delay_ms(500);
	MOV	#8, W8
	MOV	#41252, W7
L_main124:
	DEC	W7
	...
	DEC	W8
	BRA NZ	L_main124
;Lab2.c,185 :: 		Glcd_Write_TEXT("        ",0,7,1);
	MOV.B	#1, W13
	MOV.B	#7, W12
	CLR	W11
...
;Lab2.c,187 :: 		op=0;
	...
	CLR	W0
	MOV.B	W0, [W1]
;Lab2.c,188 :: 		switch(keydata){
	GOTO	L_main126
;Lab2.c,189 :: 		case 'x':
L_main128:
;Lab2.c,191 :: 		clean_PS2();
	CALL	_clean_PS2
;Lab2.c,192 :: 		texto_caso_1();
	CALL	_texto_caso_1
;Lab2.c,193 :: 		caso_1();
	CALL	_caso_1
;Lab2.c,194 :: 		break;
...
;Lab2.c,196 :: 		case 'W':
L_main129:
;Lab2.c,198 :: 		clean_PS2();
	CALL	_clean_PS2
;Lab2.c,199 :: 		texto_caso_2();
	CALL	_texto_caso_2
;Lab2.c,200 :: 		caso_2();
	CALL	_caso_2
;Lab2.c,201 :: 		break;
	GOTO	L_main127
;Lab2.c,204 :: 		case UP_ARROW:
L_main130:
;Lab2.c,205 :: 		Glcd_Write_TEXT("AR",60,7,1);
	MOV.B	#1, W13
	MOV.B	#7, W12
	MOV.B	#60, W11
...
;Lab2.c,206 :: 		break;
	GOTO	L_main127
;Lab2.c,208 :: 		case DOWN_ARROW:
L_main131:
;Lab2.c,209 :: 		Glcd_Write_TEXT("AB",60,7,1);
	MOV.B	#1, W13
	MOV.B	#7, W12
	MOV.B	#60, W11
...
;Lab2.c,212 :: 		case 'd':
L_main132:
;Lab2.c,213 :: 		cron_write();
	CALL	_cron_write
;Lab2.c,214 :: 		delay_ms(500);
	MOV	#8, W8
	MOV	#41252, W7
L_main133:
	DEC	W7
...
;Lab2.c,216 :: 		default:
L_main135:
;Lab2.c,217 :: 		Glcd_Write_TEXT("Erroneo ",60,7,1); delay_ms(500);Glcd_Write_TEXT("        ",60,7,1);
	MOV.B	#1, W13
	MOV.B	#7, W12
	MOV.B	#60, W11
