...
;laboratorio2.c,107 :: 		IC11CON1bits.ICM=0;
	...
	MOV	#lo_addr(IC11CON1bits), W0
	MOV.B	W1, [W0]
;laboratorio2.c,108 :: 		Glcd_Write_Text("t2",0,4,1);
	MOV.B	#1, W13
	MOV.B	#4, W12
	CLR	W11
	MOV	#lo_addr(?lstr36_laboratorio2), W10
	CALL	_Glcd_Write_Text
;laboratorio2.c,109 :: 		T2CONbits.TON=1;
	BSET	T2CONbits, #15
;laboratorio2.c,110 :: 		IFS0bits.T2IF=0; // limpia bandera de interrupcion
	BCLR	IFS0bits, #7
;laboratorio2.c,111 :: 		frecuencia=pulso*4*2;
	MOV	_pulso, W0
	SL	W0, #2, W0
	SL	W0, #1, W0
	ASR	W0, #15, W1
...
;laboratorio2.c,112 :: 		periodo=(1/frecuencia)*1000000;
	MOV.D	W0, W2
	MOV	#0, W0
	MOV	#16256, W1
	CALL	__Div_FP
...
;laboratorio2.c,114 :: 		void Timer4() org 0x4A{
;laboratorio2.c,115 :: 		IFS1bits.T4IF=0;
	BCLR	IFS1bits, #11
;laboratorio2.c,116 :: 		}
L_end_Timer4:
	MOV	#26, W0
...
;laboratorio2.c,117 :: 		void Timer5() org 0x4C{
;laboratorio2.c,118 :: 		IFS1bits.T5IF=0;
	BCLR	IFS1bits, #12
;laboratorio2.c,119 :: 		}
L_end_Timer5:
	MOV	#26, W0
...
;laboratorio2.c,125 :: 		unsigned short arreglo_hora_militar_up(int i,unsigned int valor_nuevo){
;laboratorio2.c,126 :: 		if(i==decena_hora){
	CP	W10, #0
	BRA Z	L__arreglo_hora_militar_up247
	GOTO	L_arreglo_hora_militar_up82
L__arreglo_hora_militar_up247:
;laboratorio2.c,127 :: 		if(valor_nuevo==4){//Decena de hora solo puede ser 0,1 o 2 2->0
	CP	W11, #4
	BRA Z	L__arreglo_hora_militar_up248
	GOTO	L_arreglo_hora_militar_up83
L__arreglo_hora_militar_up248:
;laboratorio2.c,128 :: 		return 0;
	CLR	W0
...
;laboratorio2.c,131 :: 		if(i==unidad_hora){
	CP	W10, #1
	BRA Z	L__arreglo_hora_militar_up249
	GOTO	L_arreglo_hora_militar_up84
L__arreglo_hora_militar_up249:
;laboratorio2.c,132 :: 		if(HORA[decena_hora]==2&&valor_nuevo>3){//Arreglo Hora 23->00
	MOV	#lo_addr(_hora), W0
	MOV.B	[W0], W0
	CP.B	W0, #2
...
;laboratorio2.c,133 :: 		HORA[decena_hora]=0;
	MOV	#lo_addr(_hora), W1
	CLR	W0
	MOV.B	W0, [W1]
;laboratorio2.c,134 :: 		return 0;
	CLR	W0
	GOTO	L_end_arreglo_hora_militar_up
;laboratorio2.c,132 :: 		if(HORA[decena_hora]==2&&valor_nuevo>3){//Arreglo Hora 23->00
L__arreglo_hora_militar_up167:
L__arreglo_hora_militar_up166:
;laboratorio2.c,136 :: 		if(valor_nuevo>=9){return 0;}//Arreglo Unidad Hora && Unidad Minuto 9->0
	CP	W11, #9
...
;laboratorio2.c,143 :: 		if(i==unidad_minuto){
	CP	W10, #4
	BRA Z	L__arreglo_hora_militar_up255
	GOTO	L_arreglo_hora_militar_up91
L__arreglo_hora_militar_up255:
;laboratorio2.c,144 :: 		if(valor_nuevo>9){return 0;}//Arreglo Unidad Hora && Unidad Minuto 9->0
	CP	W11, #9
...
;laboratorio2.c,147 :: 		unsigned short arreglo_hora_militar_dw(int i,unsigned int valor_nuevo){
;laboratorio2.c,148 :: 		if(i==decena_hora){
	CP	W10, #0
	BRA Z	L__arreglo_hora_militar_dw258
	GOTO	L_arreglo_hora_militar_dw93
L__arreglo_hora_militar_dw258:
;laboratorio2.c,149 :: 		if(valor_nuevo==-1){//Decena de hora solo puede ser 0,1 o 2 2->0;
	MOV	#65535, W0
	CP	W11, W0
	BRA Z	L__arreglo_hora_militar_dw259
	GOTO	L_arreglo_hora_militar_dw94
L__arreglo_hora_militar_dw259:
;laboratorio2.c,150 :: 		return 2;
	MOV.B	#2, W0
...
;laboratorio2.c,153 :: 		if(i==unidad_hora){
	CP	W10, #1
	BRA Z	L__arreglo_hora_militar_dw260
	GOTO	L_arreglo_hora_militar_dw95
L__arreglo_hora_militar_dw260:
;laboratorio2.c,154 :: 		if(HORA[decena_hora]==0&&valor_nuevo<0){//Arreglo Hora 23->00
	MOV	#lo_addr(_hora), W0
	MOV.B	[W0], W0
	CP.B	W0, #0
...
;laboratorio2.c,155 :: 		HORA[decena_hora]=2;
	MOV	#lo_addr(_hora), W1
	MOV.B	#2, W0
	MOV.B	W0, [W1]
;laboratorio2.c,156 :: 		return 3;
	MOV.B	#3, W0
	GOTO	L_end_arreglo_hora_militar_dw
;laboratorio2.c,154 :: 		if(HORA[decena_hora]==0&&valor_nuevo<0){//Arreglo Hora 23->00
L__arreglo_hora_militar_dw170:
L__arreglo_hora_militar_dw169:
;laboratorio2.c,157 :: 		}else if(valor_nuevo<0){return 9;}//Arreglo Unidad Hora && Unidad Minuto 9->0
	CP	W11, #0
...
;laboratorio2.c,164 :: 		if(i==unidad_minuto){
	CP	W10, #4
	BRA Z	L__arreglo_hora_militar_dw266
	GOTO	L_arreglo_hora_militar_dw103
L__arreglo_hora_militar_dw266:
;laboratorio2.c,165 :: 		if(valor_nuevo<0){return 9;}//Arreglo Unidad Hora && Unidad Minuto 9->0
	CP	W11, #0
...
;laboratorio2.c,169 :: 		void cron_write(){
;laboratorio2.c,170 :: 		Glcd_Write_TEXT("                                              ",60,7,1);
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
	...
	CALL	_Glcd_Write_Text
;laboratorio2.c,171 :: 		i=0;
	CLR	W0
	MOV	W0, _i
;laboratorio2.c,172 :: 		for(i=0;i<12;i++){
	CLR	W0
	MOV	W0, _i
L_cron_write105:
	MOV	_i, W0
...
L__cron_write269:
;laboratorio2.c,173 :: 		Glcd_Write_Char(HORA[i],50+i*5,7,1);
	MOV	_i, W1
	MOV	#5, W0
	MUL.UU	W1, W0, W2
	MOV	#50, W0
...
;laboratorio2.c,176 :: 		void num_update(int it,int x_pos,int page){
;laboratorio2.c,177 :: 		Glcd_Write_Char(it+'0',x_pos,page,1);
	PUSH	W10
	PUSH	W13
	MOV	#48, W0
	ADD	W10, W0, W0
...
;laboratorio2.c,180 :: 		int  num_selector(int x_pos,int indice){
;laboratorio2.c,181 :: 		int it=0;
	PUSH	W12
	MOV	#0, W0
	MOV	W0, [W14+0]
;laboratorio2.c,182 :: 		num_update(it,x_pos,7);
	PUSH.D	W10
	MOV	#7, W12
	MOV	W10, W11
	MOV	[W14+0], W10
	CALL	_num_update
	POP.D	W10
;laboratorio2.c,183 :: 		clean_PS2();
	CALL	_clean_PS2
;laboratorio2.c,184 :: 		while(keydata!=ENTER){
L_num_selector108:
	MOV	#lo_addr(_keydata), W0
	MOV.B	[W0], W0
	CP.B	W0, #13
...
L__num_selector272:
;laboratorio2.c,185 :: 		if(Ps2_Key_Read(&keydata, &special, &down)){
	PUSH.D	W10
	MOV	#lo_addr(_down), W12
	MOV	#lo_addr(_special), W11
	MOV	#lo_addr(_keydata), W10
...
L__num_selector273:
;laboratorio2.c,186 :: 		if(down){
	MOV	#lo_addr(_down), W0
	CP0.B	[W0]
	BRA NZ	L__num_selector274
	GOTO	L_num_selector111
L__num_selector274:
;laboratorio2.c,187 :: 		if(keydata==DOWN_ARROW||keydata==UP_ARROW){
	MOV	#lo_addr(_keydata), W0
	MOV.B	[W0], W1
	MOV.B	#108, W0
	CP.B	W1, W0
...
L__num_selector173:
L__num_selector172:
;laboratorio2.c,188 :: 		if(keydata==UP_ARROW){
	MOV	#lo_addr(_keydata), W0
	MOV.B	[W0], W1
	MOV.B	#111, W0
	CP.B	W1, W0
...
L__num_selector277:
;laboratorio2.c,189 :: 		it=it+1;
	MOV	[W14+0], W0
	INC	W0
;laboratorio2.c,190 :: 		it=arreglo_hora_militar_up(indice,it);
	PUSH.D	W10
	MOV	W11, W10
	MOV	W0, W11
...
;laboratorio2.c,192 :: 		}
L_num_selector115:
;laboratorio2.c,193 :: 		if(keydata==DOWN_ARROW){
	MOV	#lo_addr(_keydata), W0
	MOV.B	[W0], W1
	MOV.B	#108, W0
	CP.B	W1, W0
...
;laboratorio2.c,194 :: 		it=it-1;
	MOV	[W14+0], W0
	DEC	W0
;laboratorio2.c,195 :: 		it=arreglo_hora_militar_dw(indice,it);
	PUSH.D	W10
	MOV	W11, W10
	MOV	W0, W11
...
;laboratorio2.c,197 :: 		}
L_num_selector116:
;laboratorio2.c,198 :: 		num_update(it,x_pos,7);
	PUSH.D	W10
	MOV	#7, W12
	MOV	W10, W11
	MOV	[W14+0], W10
...
;laboratorio2.c,207 :: 		void cron_cursor(){
;laboratorio2.c,208 :: 		int x_pos=50,i,j;
	PUSH	W10
	PUSH	W11
;laboratorio2.c,210 :: 		clean_PS2();
	CALL	_clean_PS2
;laboratorio2.c,211 :: 		for(i=0;i<5;i++){
; i start address is: 24 (W12)
	CLR	W12
; i end address is: 24 (W12)
L_cron_cursor117:
...
L__cron_cursor280:
;laboratorio2.c,212 :: 		if(i!=2){
	CP	W12, #2
	BRA NZ	L__cron_cursor281
	GOTO	L_cron_cursor120
L__cron_cursor281:
;laboratorio2.c,213 :: 		j=num_selector(50+i*5,i)+'0';
	MOV	#5, W0
	MUL.SS	W12, W0, W2
	MOV	#50, W0
	ADD	W0, W2, W0
	...
	MOV	#48, W1
	ADD	W0, W1, W1
;laboratorio2.c,214 :: 		HORA[i]=j;
	MOV	#lo_addr(_hora), W0
	ADD	W0, W12, W0
	MOV.B	W1, [W0]
;laboratorio2.c,215 :: 		}else if(i==2){
...
L_cron_cursor122:
L_cron_cursor121:
;laboratorio2.c,218 :: 		clean_PS2();
	CALL	_clean_PS2
;laboratorio2.c,219 :: 		cron_write();
	CALL	_cron_write
;laboratorio2.c,211 :: 		for(i=0;i<5;i++){
	INC	W12
;laboratorio2.c,220 :: 		}
...
;laboratorio2.c,222 :: 		void caso_1(){
;laboratorio2.c,223 :: 		while(keydata!=ESC){
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
L_caso_1123:
	...
	GOTO	L_caso_1124
L__caso_1284:
;laboratorio2.c,224 :: 		selected=cursor_menu(5);
	MOV	#5, W10
	CALL	_cursor_menu
	MOV	W0, _selected
;laboratorio2.c,225 :: 		switch(selected){
	GOTO	L_caso_1125
;laboratorio2.c,226 :: 		case 1:
L_caso_1127:
;laboratorio2.c,227 :: 		cron_cursor();
	CALL	_cron_cursor
;laboratorio2.c,228 :: 		clean_PS2();
	CALL	_clean_PS2
;laboratorio2.c,229 :: 		break;
	GOTO	L_caso_1126
;laboratorio2.c,230 :: 		case 2:
L_caso_1128:
;laboratorio2.c,231 :: 		Glcd_Write_Text("PLAY",30,7,1);
	MOV.B	#1, W13
	MOV.B	#7, W12
	MOV.B	#30, W11
	MOV	#lo_addr(?lstr38_laboratorio2), W10
	CALL	_Glcd_Write_Text
;laboratorio2.c,232 :: 		T1CONBits.TON=1;
	BSET	T1CONbits, #15
;laboratorio2.c,233 :: 		break;
	GOTO	L_caso_1126
;laboratorio2.c,234 :: 		case 3:
L_caso_1129:
;laboratorio2.c,235 :: 		Glcd_Write_Text("pause",30,7,1);
	MOV.B	#1, W13
	MOV.B	#7, W12
	MOV.B	#30, W11
	MOV	#lo_addr(?lstr39_laboratorio2), W10
	CALL	_Glcd_Write_Text
;laboratorio2.c,236 :: 		T1CONBits.TON=0;
	BCLR	T1CONbits, #15
;laboratorio2.c,237 :: 		break;
	GOTO	L_caso_1126
;laboratorio2.c,238 :: 		case 4:
L_caso_1130:
;laboratorio2.c,239 :: 		Glcd_Write_Text("RESET",30,7,1);
	MOV.B	#1, W13
	MOV.B	#7, W12
	MOV.B	#30, W11
	MOV	#lo_addr(?lstr40_laboratorio2), W10
	CALL	_Glcd_Write_Text
;laboratorio2.c,241 :: 		break;
	GOTO	L_caso_1126
;laboratorio2.c,242 :: 		case 5:
L_caso_1131:
;laboratorio2.c,243 :: 		Glcd_Write_Text("ALARM",30,7,1);
	MOV.B	#1, W13
	MOV.B	#7, W12
	MOV.B	#30, W11
	MOV	#lo_addr(?lstr41_laboratorio2), W10
	CALL	_Glcd_Write_Text
;laboratorio2.c,245 :: 		break;
	GOTO	L_caso_1126
;laboratorio2.c,246 :: 		}
L_caso_1125:
	MOV	_selected, W0
...
;laboratorio2.c,250 :: 		void frecuencia_pantalla (){
;laboratorio2.c,251 :: 		Glcd_Write_Text("Frecu.(hz)=", 0, 1, 1);
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
	...
	CALL	_Glcd_Write_Text
;laboratorio2.c,252 :: 		floattostr(frecuencia,txt);
	MOV	#lo_addr(_txt), W12
	MOV	_frecuencia, W10
	MOV	_frecuencia+2, W11
	CALL	_FloatToStr
;laboratorio2.c,253 :: 		Glcd_Write_Text(txt,65, 1, 1);
	MOV.B	#1, W13
	MOV.B	#1, W12
	MOV.B	#65, W11
	MOV	#lo_addr(_txt), W10
	CALL	_Glcd_Write_Text
;laboratorio2.c,254 :: 		floattostr(periodo,txt);
	MOV	#lo_addr(_txt), W12
	MOV	_periodo, W10
	MOV	_periodo+2, W11
	CALL	_FloatToStr
;laboratorio2.c,255 :: 		Glcd_Write_Text(txt,65, 2, 1);
	MOV.B	#1, W13
	MOV.B	#2, W12
	MOV.B	#65, W11
	MOV	#lo_addr(_txt), W10
...
;laboratorio2.c,257 :: 		void caso_2(){
;laboratorio2.c,258 :: 		config_captura();
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
	CALL	_config_captura
;laboratorio2.c,259 :: 		T2CONbits.TON=1; //enciende timer 1
	BSET	T2CONbits, #15
;laboratorio2.c,260 :: 		Glcd_Fill(0);
	CLR	W10
	CALL	_Glcd_Fill
;laboratorio2.c,261 :: 		while(keydata!=ESC){
L_caso_2132:
	MOV	#lo_addr(_keydata), W0
	MOV.B	[W0], W1
	MOV.B	#118, W0
	...
	GOTO	L_caso_2133
L__caso_2292:
;laboratorio2.c,262 :: 		frecuencia_pantalla();
	CALL	_frecuencia_pantalla
;laboratorio2.c,263 :: 		Glcd_Write_TEXT("c2" ,10,7,1);delay_ms(1000);
	MOV.B	#1, W13
	MOV.B	#7, W12
	MOV.B	#10, W11
...
L_caso_2134:
	...
	NOP
	NOP
;laboratorio2.c,268 :: 		Ps2_Key_Read(&keydata, &special, &down);
	MOV	#lo_addr(_down), W12
	MOV	#lo_addr(_special), W11
	MOV	#lo_addr(_keydata), W10
	CALL	_Ps2_Key_Read
...
;laboratorio2.c,272 :: 		void caso_3(){
;laboratorio2.c,273 :: 		texto_caso_3();
	PUSH	W10
	PUSH	W11
	PUSH	W12
	CALL	_texto_caso_3
;laboratorio2.c,274 :: 		T5CONbits.TON=1;
	BSET	T5CONbits, #15
;laboratorio2.c,275 :: 		T4CONbits.TON=1;
	BSET	T4CONbits, #15
;laboratorio2.c,276 :: 		delay_ms(300);
	MOV	#5, W8
	MOV	#37858, W7
L_caso_3136:
	DEC	W7
	...
	BRA NZ	L_caso_3136
	NOP
;laboratorio2.c,277 :: 		while(keydata!=ESC){
L_caso_3138:
	MOV	#lo_addr(_keydata), W0
	MOV.B	[W0], W1
	MOV.B	#118, W0
	...
	GOTO	L_caso_3139
L__caso_3294:
;laboratorio2.c,278 :: 		Ps2_Key_Read(&keydata, &special, &down);
	MOV	#lo_addr(_down), W12
	MOV	#lo_addr(_special), W11
	MOV	#lo_addr(_keydata), W10
	CALL	_Ps2_Key_Read
;laboratorio2.c,279 :: 		}
	GOTO	L_caso_3138
L_caso_3139:
;laboratorio2.c,280 :: 		T5CONbits.TON=0;
	BCLR	T5CONbits, #15
;laboratorio2.c,281 :: 		T4CONbits.TON=0;
	BCLR	T4CONbits, #15
;laboratorio2.c,282 :: 		}
L_end_caso_3:
	POP	W12
...
;laboratorio2.c,284 :: 		void main(){
;laboratorio2.c,285 :: 		config_IO();  config_LCD();
	PUSH	W10
	CALL	_config_IO
	CALL	_config_LCD
;laboratorio2.c,286 :: 		config_INT();
	CALL	_config_INT
;laboratorio2.c,288 :: 		config_OC();
	CALL	_config_OC
;laboratorio2.c,289 :: 		config_TMR_45();
	CALL	_config_TMR_45
;laboratorio2.c,291 :: 		config_pin();
	CALL	_config_pin
;laboratorio2.c,294 :: 		Glcd_Fill(0);
	CLR	W10
	CALL	_Glcd_Fill
;laboratorio2.c,296 :: 		PS2_Config();  Glcd_Fill(0);
	CALL	_Ps2_Config
	CLR	W10
	CALL	_Glcd_Fill
;laboratorio2.c,297 :: 		while(1){
L_main140:
;laboratorio2.c,298 :: 		texto_menu();
	CALL	_texto_menu
;laboratorio2.c,299 :: 		selected=cursor_menu(3);
	MOV	#3, W10
	CALL	_cursor_menu
	MOV	W0, _selected
;laboratorio2.c,300 :: 		switch(selected){
	GOTO	L_main142
;laboratorio2.c,301 :: 		case 1:
L_main144:
;laboratorio2.c,302 :: 		clean_PS2();
	CALL	_clean_PS2
;laboratorio2.c,303 :: 		texto_caso_1();
	CALL	_texto_caso_1
;laboratorio2.c,304 :: 		caso_1();
	CALL	_caso_1
;laboratorio2.c,305 :: 		break;
	GOTO	L_main143
;laboratorio2.c,306 :: 		case 2:
L_main145:
;laboratorio2.c,307 :: 		clean_PS2();
	CALL	_clean_PS2
;laboratorio2.c,309 :: 		caso_2();
	CALL	_caso_2
;laboratorio2.c,310 :: 		break;
	GOTO	L_main143
;laboratorio2.c,311 :: 		case 3:
L_main146:
;laboratorio2.c,312 :: 		clean_PS2();
	CALL	_clean_PS2
;laboratorio2.c,313 :: 		texto_caso_3();
	CALL	_texto_caso_3
;laboratorio2.c,314 :: 		caso_3();
	CALL	_caso_3
;laboratorio2.c,315 :: 		break;
	GOTO	L_main143
;laboratorio2.c,316 :: 		}
L_main142:
	MOV	_selected, W0
